...
import com.algaworks.brewer.thymeleaf.processor.MessageElementTangProcessor;
import com.algaworks.brewer.thymeleaf.processor.OrderElementTagProcessor;
import com.algaworks.brewer.thymeleaf.processor.PaginacaoElementTagProcessor;
...
public class BrewerDialect extends AbstractProcessorDialect{
	...
	public Set<IProcessor> getProcessors(String dialectPrefix) {
		...
		processadores.add(new MessageElementTangProcessor(dialectPrefix));
