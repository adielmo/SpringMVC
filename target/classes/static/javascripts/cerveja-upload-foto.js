...
Brewer.UploadFoto = (function(){
	...
	UploadFoto.prototype.iniciar = function(){
		...
		if (this.inputNomeFoto.val()) {
			rederizarFoto.call(this,{nome: this.inputNomeFoto.val(), contentType: this.inputContentType.val()});
	...
	function onUploadCompleto(resposta){
		...
		rederizarFoto.call(this, resposta);
		
	}
	
	function rederizarFoto(resposta){
